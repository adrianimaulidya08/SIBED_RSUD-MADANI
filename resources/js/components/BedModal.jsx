                ...
                <div className="toggle-options">
                  <label className={`toggle-option ${isIsolation ? 'active' : ''}`}>
                    ...
                    <span className="toggle-label">
                      <svg className="isolation-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <label className={`toggle-option ${isVentilator ? 'active' : ''}`}>
                    ...
                    <span className="toggle-switch"></span>
                    <span className="toggle-label">
                      <svg className="ventilator-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
